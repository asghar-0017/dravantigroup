...
const TerritoriesCovered = () => {
  return (
    <div className="territories-container container">
      <div className="territories-header container">
        <h2>Territories Covered</h2>
      </div>
      <div className="territories-content container">
        <p>
      ...
      <div className="territories-cards container">
