...
import '../../assets/style/tokanization.css';
  ...
  return (
    <div className="parent">
      <div className="main-div">
        <h2 className="heading-tokanization">Tokenization in the Market</h2>
      </div>
      <div className="description-tokanization">
      ...
      <div className="timeline-graph-container">
        ...
        <div className="graph-section">
          ...
          <h2 className="future-market">The future market potential of tokenization is expected to reach ~10.9 Trillion USD by 2030</h2>
        </div>
      </div>
      {/* <div className='sec-token'>
      <img src={sec_image} alt="Tokenization Visual" />
      </div> */}
    </div>
  );
};
